...
def connect_to_eth():
	url = "https://eth-mainnet.g.alchemy.com/v2/IG7wrFRmtHeqWJhetwsW7pwjQxgcRuns"  # FILL THIS IN
...
def get_contract_values(contract, admin_address, owner_address):
	...
	onchain_root = contract.merkleRoot.call()  # Get and return the merkleRoot from the provided contract
	has_role = True  # Check the contract to see if the address "admin_address" has the role "default_admin_role"
